  ...
  constructor(private sanitizer: DomSanitizer) {
    ...
    this.ehrenamt = [
      ...
      'Dem Ehrenamt fehlt es zunehmend an tragenden Schultern: Wir wollen das ändern.' +
        ...
        'Ihr könnt durch impact also mit vielen neuen MitstreiterInnen rechnen - speziell die Jüngeren möchten wir durch unser Konzept ' +
    ...
    this.ergaenzen = [
      ...
      'Unser Team hat das notwendige Know-How, das ambitionierte Projekt umzusetzen. ' +
        'Um Euch bestmöglich zu unterstützen, brauchen wir jedoch Euch mit Eurer langjährigen Praxiserfahrung im Ehrenamt als Input. ' +
